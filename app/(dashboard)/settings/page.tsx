        ...
        <div className="workspace bg-[#F9FAFB] p-6 overflow-y-auto">
          <div className="min-w-3xl mx-auto">
            <div className="mb-6">
              ...
              <p className="text-[15px] text-[rgba(0,0,0,0.5)] m-0">配置您的 AI 模型和偏好设置</p>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      type="checkbox"
                      id="auto-save"
                      className="w-5 h-5 rounded border-[rgba(0,0,0,0.2)] accent-[#007AFF]"
                      defaultChecked
                    />
                    <label htmlFor="auto-save" className="text-[15px] text-[#1D1D1F]">
                      自动保存图表
                    </label>
                  </div>
                </div>
